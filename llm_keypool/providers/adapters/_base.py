...
from ..base import BaseProvider, CompletionOptions, ChatCompletionResponse, ChatCompletionChunk
...
class OpenAICompatProvider(BaseProvider):
    ...
    ``llm_keypool.providers.openai_compat`` at runtime.
    """
    ...
    async def stream_chat_completion(
        ...
        model = model_id or self.default_model
        async for chunk in _openai_complete(
            api_key=api_key,
            messages=messages,
            model=model,
            base_url=self.base_url,
