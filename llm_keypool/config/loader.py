...
def load_settings() -> AppSettings:
    ...
    _settings.router.decay_interval_ms = int(env("LLM_ROUTER_DECAY_INTERVAL_MS", "120000"))
    _settings.health.check_interval_ms = int(env("LLM_HEALTH_CHECK_INTERVAL_MS", "300000"))
    _settings.handoff.session_ttl_ms = int(env("LLM_HANDOFF_SESSION_TTL_MS", "10800000"))
...
__all__ = [
    "AppSettings", "StrategyWeights", "StrategyDef", "FallbackConfig",
    "RouterConstants", "HealthConfig", "HandoffConfig", "StickyConfig",
    "load_settings", "reload_settings", "load_providers_config",
]
