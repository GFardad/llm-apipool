...
def upgrade() -> None:
    ...
    op.add_column("models", sa.Column("supports_streaming", sa.Integer(), nullable=False, server_default="1"))
    op.add_column("models", sa.Column("supports_function_calling", sa.Integer(), nullable=False, server_default="0"))
    op.add_column("models", sa.Column("is_free", sa.Integer(), nullable=False, server_default="1"))
    op.add_column("models", sa.Column("is_deprecated", sa.Integer(), nullable=False, server_default="0"))
    op.add_column("models", sa.Column("tier", sa.Integer(), nullable=False, server_default="4"))
    ...
    op.add_column("models", sa.Column("last_updated_at", sa.Text(), nullable=False, server_default=sa.text("datetime('now')")))
